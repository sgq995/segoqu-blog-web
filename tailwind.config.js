  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neumorphism-md': '-4px -4px 6px -1px rgba(255, 255, 255, 0.99), -2px -2px 4px -1px rgba(255, 255, 255, 0.94), 4px 4px 6px -1px rgba(0, 0, 0, 0.1), 2px 2px 4px -1px rgba(0, 0, 0, 0.06)',
        ...
        'inner-neumorphism-md': 'inset -4px -4px 6px -1px rgba(255, 255, 255, 0.99), inset -2px -2px 4px -1px rgba(255, 255, 255, 0.94), inset 4px 4px 6px -1px rgba(0, 0, 0, 0.1), inset 2px 2px 4px -1px rgba(0, 0, 0, 0.06)',
